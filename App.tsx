...
import { Play, Pause, Music, Mic, Wand2, Download, ChevronRight, RotateCcw, Check, Sparkles, AlertCircle, Volume2, StopCircle, Edit3, Lock, CreditCard, X, QrCode, Store, Megaphone, ExternalLink } from 'lucide-react';
...
export default function App() {
  ...
  const handleCaktoRedirect = () => {
      ...
      // Você deve substituir isso pelo seu Link de Pagamento real
      // E configurar a "URL de Retorno" na Cakto para: https://seusite.com/?status=paid
      
      const MOCK_CHECKOUT_URL = window.location.href.split('?')[0] + "?status=paid"; // Simulando retorno
      
      // Em produção use:
      // window.location.href = "https://cakto.com.br/checkout/seu-codigo-produto";
      
      alert("Em produção, isso redirecionaria para o checkout da Cakto.");
      ...
      <main className="w-full max-w-4xl bg-gray-800/50 backdrop-blur-sm border border-gray-700 rounded-3xl p-6 md:p-10 shadow-2xl min-h-[500px] flex flex-col relative overflow-hidden">
        ...
        {step === AppStep.RESULT && jingleData && (
          <div className="flex flex-col h-full animate-fade-in">
            ...
            <div className="bg-gray-900 rounded-2xl p-6 border border-gray-700 mb-8 shadow-xl">
               ...
               {!isPaid ? (
                 <div className="space-y-3">
                    ...
                    >
                       ...
                       Comprar Licença & Baixar - R$ 29,90
                    </button>
        ...
        {showPaymentModal && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-sm animate-fade-in">
             <div className="bg-gray-800 border border-gray-600 rounded-2xl p-6 w-full max-w-md shadow-2xl relative">
                ...
                <p className="text-gray-400 text-sm mb-6">Libere o download imediato do seu jingle.</p>
                ...
                <div className="bg-white p-6 rounded-xl flex flex-col items-center mb-6">
                   ...
                   <p className="text-gray-800 font-bold text-lg mb-1">R$ 29,90</p>
